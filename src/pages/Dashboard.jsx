...
const Dashboard = () => {
  ...
  const fetchStats = async () => {
    setLoading(true);
    try {
      const res = await axios.get('https://seversecurity-production.up.railway.app/api/reports/dashboard-stats');
      setStats(res.data);
    } catch (err) {
  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        {loading ? (
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-6'><Skeleton count={4} height={200} /></div>
